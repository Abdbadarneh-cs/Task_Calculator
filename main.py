...
# label_result = Label(root, width=25, height=2, text="", font=("arial", 30), bg="#1e1e1e", fg="white", anchor="e")
# label_result.pack()

# Button(root, text="C", width=5, height=1, font=("arial", 30, "bold"), bd=1 , fg="#fff",bg="#3697f5", command=lambda: clear()).place(x=10 , y=100)
# Button(root, text="/", width=5, height=1, font=("arial", 30, "bold"), bd=1 , fg="#fff",bg="#ff9500", command=lambda: show("/")).place(x=150 , y=100)
# Button(root, text="%", width=5, height=1, font=("arial", 30, "bold"), bd=1 , fg="#fff",bg="#ff9500", command=lambda: show("%")).place(x=290 , y=100)
# Button(root, text="*", width=5, height=1, font=("arial", 30, "bold"), bd=1 , fg="#fff",bg="#ff9500", command=lambda: show("*")).place(x=430 , y=100)
...
# Button(root, text="-", width=5, height=1, font=("arial", 30, "bold"), bd=1 , fg="#fff",bg="#ff9500", command=lambda: show("-")).place(x=430 , y=200)
...
# Button(root, text="+", width=5, height=1, font=("arial", 30, "bold"), bd=1 , fg="#fff",bg="#ff9500", command=lambda: show("+")).place(x=430 , y=300)
...
# Button(root, text="=", width=5, height=3, font=("arial", 30, "bold"), bd=1 , fg="#fff",bg="#ff9500", command=lambda: calculate() ).place(x=430 , y=400)
